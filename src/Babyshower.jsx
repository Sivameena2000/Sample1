    ...
    <Col lg={6} ><img src="couplebanner.jpg" className='img-fluid'/></Col> */}
      ...
      <Modal show={show} onHide={handleClose}>
        ...
        <Modal.Body className="model-div">
          <div>
            <p>
              BabyShower can be quite stressful for parents and all those who
          ...
          <div>
            <h4>BABY SHOWER PACKAGE #1: PRICE BASED ON THE HOURS OF FOOTAGE</h4>
            <p>
              One package can include full-day coverage and an unlimited number
              of photos taken during the babyshower . The number of photos can
          ...
          <div className="mt-4">
            <h4>
              BABY SHOWER PACKAGE #2: OFFER MORE PHOTOGRAPHERS TO COVER
              DIFFERENT OCCASIONS
            </h4>
            <p>
          ...
          <div className="mt-4">
            <h4>
              BABY SHOWER PACKAGE #3: OFFER PERSONALIZED PHOTO ALBUM’S COVERS
            </h4>
            <p>
